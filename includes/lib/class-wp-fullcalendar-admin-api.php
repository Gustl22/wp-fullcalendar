 ...
 * Admin API class.
 */
class WP_Fullcalendar_Admin_API {
	...
	public function display_field( $data = array(), $post = null, $echo = true ) {
		...
		switch ( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image', 'wp-fullcalendar' ) . '" data-uploader_button_text="' . __( 'Use image', 'wp-fullcalendar' ) . '" class="image_upload_button button" value="' . __( 'Upload new image', 'wp-fullcalendar' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="' . __( 'Remove image', 'wp-fullcalendar' ) . '" />' . "\n";
